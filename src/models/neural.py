...
class HybridNet(nn.Module):
    ...
    def __init__(
        ...
        self.attention = nn.MultiheadAttention(
            embed_dim=n_factors, num_heads=4, dropout=dropout, batch_first=True
        )
    ...
    def forward(
        ...
        attended_user, _ = self.attention(user_context, item_context, item_context)
        ...
        # Final prediction
        prediction = (
            self.fusion(combined).squeeze(-1) + user_bias + item_bias + self.global_bias
        )
